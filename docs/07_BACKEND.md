...
│   │           └── practice.py       # drills + mastery (Sprint 16)
│   ├── core/
...
│   │       ├── practice_service.py           # on-demand drills (Sprint 16)
│   │       └── mastery_service.py            # per-topic mastery (Sprint 16)
│   ├── infrastructure/
│   │   ├── db/
...
│   │   ├── generation_worker.py  # background curriculum generation (Sprint 11)
